		...
		<div className="o-footer__container">
			<div>
				<ul className="o-footer__legal-links">
					...
					<li>
						<a href="http://help.ft.com/help/legal-privacy/privacy/">
							Privacy
						</a>
					</li>
					<li>
